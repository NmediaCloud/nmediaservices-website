            ...
            <div className="grid lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-20 h-20 rounded-full bg-primary/90 group-hover:bg-primary flex items-center justify-center shadow-xl shadow-primary/40 transition-all group-hover:scale-110">
              ...
              <div className="flex flex-col justify-end">
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-14 h-14 rounded-full bg-primary/90 group-hover:bg-primary flex items-center justify-center shadow-xl shadow-primary/40 transition-all group-hover:scale-110">
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <div className="bg-gradient-to-br from-primary/10 via-surface-container to-surface-container border border-primary/35 hover:border-primary/50 transition-all duration-300 overflow-hidden group">
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-20 h-20 rounded-full bg-primary/90 group-hover:bg-primary flex items-center justify-center transition-all group-hover:scale-110 shadow-xl shadow-primary/40">
                      <span className="material-symbols-outlined text-on-primary" style={{ fontSize: "44px" }}>play_arrow</span>
                    </div>
                  </div>
                </button>
